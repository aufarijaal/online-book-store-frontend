...
async function getBook() {
  ...
  const result = await useApiFetch(
    `/api/v1/books/detail/${route.params.bookSlug}`,
    {
      headers: {
        ...
        <div class="col">
          ...
          <div class="mt-4">
            ...
            <p class="text-sm" style="text-align: justify">
              ...
              enim reprehenderit provident consequuntur nisi praesentium placeat
              unde, eum illum consectetur facere ratione veritatis sunt amet
              aliquid laborum labore numquam atque sapiente! Quibusdam
              repudiandae itaque sunt cum eveniet similique unde! Consectetur
              quisquam tempora molestiae impedit omnis, ab et officia, suscipit
              non voluptatem doloremque, facere commodi. Sequi expedita dolores
              dignissimos mollitia ducimus incidunt aliquam nobis quae quasi
              delectus reprehenderit ipsam ab sed repellendus ullam facere,
              saepe a deleniti? Placeat consequatur, exercitationem maiores,
              similique iure qui, quisquam magni impedit autem omnis deleniti
              laudantium quis inventore. Distinctio suscipit laudantium
              perferendis. Odit nam consequatur neque necessitatibus. Aut
              deleniti doloremque a magnam cupiditate totam incidunt, maiores
              aliquam tenetur odio impedit unde repellat. Distinctio sed
              quibusdam, saepe pariatur at molestiae maiores exercitationem
              numquam natus eveniet debitis consequuntur voluptatibus recusandae
              officiis incidunt maxime nisi eligendi laboriosam eos inventore.
              Mollitia repellendus, vero quis explicabo amet fugiat quaerat
              tempore molestias impedit facere excepturi omnis reiciendis unde
              voluptate doloribus architecto eaque quidem beatae sunt iure iusto
              asperiores? Maiores ullam optio dolore, quo natus possimus culpa
              odio deserunt consequuntur dolor? Cum asperiores sit cumque, animi
              dolorum, adipisci natus hic sunt qui quidem nulla nemo voluptate
