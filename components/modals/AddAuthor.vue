...
async function submit() {
  ...
  const result = await useApiFetch('/api/v1/admin/authors', {
    method: 'POST',
    body: form.value,
    headers: {
  ...
  <div class="custom-modal-backdrop">
    <div class="custom-modal">
      ...
      <div class="custom-modal__body">
        <form id="add-author-form" @submit.prevent="submit">
          <!-- Name -->
          <div class="mb-3">
          ...
          <div class="mb-3">
            <div class="input-group">
              ...
              <input type="date" class="form-control" id="dob" aria-describedby="dobHelp" required v-model="form.dob" />
            </div>
            <div
              id="dobHelp"
              class="form-text text-xs text-danger"
